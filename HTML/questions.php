 ...
 <fieldset for="questions">
  <legend> Please answer the following questions  </legend>
    ...
    <label>
        ...
        <input type ="checkbox" name="activity1" value="camp"/> Camping
        <input type ="checkbox" name="activity2" value="hike"/> Hiking 
        <input type ="checkbox" name="activity3" value="fishing"/> Fishing
        <input type ="checkbox" name="activity4" value="mountainbike"/> Mountain Biking <br/>
        <input type ="checkbox" name="activity5" value="kayak"/> Kayaking  
        <input type ="checkbox" name="activity6" value="paddleboard"/> Paddle Boarding  
        <input type ="checkbox" name="activity7" value="surf"/> Surfing 
        <input type ="checkbox" name="activity8" value="other"/> Other 
    </label> <br/><br/>
    ...
    <label>
        ...
        <input type="radio" name="diff" value="small"/> Novice 
        <input type="radio" name="diff" value="medium"/> Intermediate 
        <input type="radio" name="diff" value="large"/> Advanced 
    </label> <br/><br/>
